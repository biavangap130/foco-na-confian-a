          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <ul className="space-y-2 text-primary-foreground/60 text-sm">
                <li><a href="<h1>Privacy Policy</h1>
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Segredo Masculino.</p>
</li>
<li>
<p><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</p>
</li>
<li>
<p><strong>Country</strong> refers to:  Angola</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Segredo Masculino, accessible from <a href="www.segredomasculino.shop" rel="external nofollow noopener" target="_blank">www.segredomasculino.shop</a>.</p>
</li>
<li>
...
<ul>
<li>By phone: +351920814187</li>
</ul>" className="hover:text-accent transition-colors">Política de Privacidade</a></li>
